...
<div class="nk-block-head-content"><h2 class="nk-block-title">Add News</h2>
<nav><ol class="breadcrumb breadcrumb-arrow mb-0">
    <li class="breadcrumb-item"><a href="#">Home</a></li>
    <li class="breadcrumb-item active" aria-current="page">Add News</li></ol></nav></div>
...
if(isset($_POST['submit'])){
    $ins=mysqli_query($conn,"INSERT INTO news(tittle,date,district,description) values ('".$_POST['tittle']."','".$_POST['date']."','".$_POST['district']."','".$_POST['description']."')");
        ...
        if($_FILES['photo']['name']!=""){
            ...
            if($check != false){
                if(move_uploaded_file($_FILES["photo"]["tmp_name"],$target_file)){
                    ...
                    tittle='".$_POST['tittle']."',
                    district='".$_POST['district']."',date='".$_POST['date']."',
                    photo='".$target_file."'
                    where nid='".$id."'");
                }
            }        }
        if($_FILES['photo1']['name']!=""){
            ...
            if($check1 != false){
                if(move_uploaded_file($_FILES["photo1"]["tmp_name"],$target_file1)){
                   ...
                   district='".$_POST['district']."',date='".$_POST['date']."' where nid='".$id."'");
                }
            }
        }
...
<div class="form-control-wrap">
    <input required type="text" class="form-control" id="name" name="tittle" placeholder="Enter News Title"></div></div></div>
...
<div class="form-group"><label class="form-label">Description</label><div class="form-control-wrap"><div class="js-quill" data-toolbar="minimal" data-placeholder="Write description here..." id="disp"></div></div></div>
    


<div class="form-group"><label class="form-label">Profile Photo<spam>*</spam></label>
<div class="image-upload-wrap">
<div class="media media-huge d-flex ml-3">
<div class='row m-1'>
    <img id="image-result" style='margin-left:50px' height='90px' width='100px'>
    <label for="change-image" class="btn btn-sm btn-primary" style='margin-left:52px;margin-top:10px'>Add Image</label>
</div>
<div class='row m-1'>
    <img id="image-result1" style='margin-left:50px' height='90px' width='100px'>
    <label for="change-image1" class="btn btn-sm btn-primary" style='margin-left:47px;margin-top:10px'>Add Image</label>
</div>
<div class='row m-1'>
    <img id="image-result2" style='margin-left:50px' height='90px' width='100px'>
    <label for="change-image2" class="btn btn-sm btn-primary" style='margin-left:47px;margin-top:10px'>Add Image</label>

    </div>
<div class='row m-1'>
    <img id="image-result3" style='margin-left:50px' height='90px' width='100px'>
    <label for="change-image3" class="btn btn-sm btn-primary" style='margin-left:47px;margin-top:10px'>Add Image</label>
    </div>
<div class='row m-1'>
    <img id="image-result4" style='margin-left:50px' height='90px' width='100px'>
    <label for="change-image4" class="btn btn-sm btn-primary" style='margin-left:47px;margin-top:10px'>Add Image</label>
    </div>
<div class='row m-1'>
    <img id="image-result5" style='margin-left:50px' height='90px' width='100px'>
...
<input required type="submit" id="submit" name="submit" class="btn btn-primary" style="margin-left:4%;margin-bottom:20px;margin-top:20px;" value="Save Changes"></div></form>
</div></div>   
</body>
</html>
