...
<div class="nk-content">
    ...
    <div class="nk-block-head-content">
        <h2 class="nk-block-title">Members List</h1>
    ...
    <li>&nbsp;&nbsp;<a href="add-member.php" class=" btn btn-primary"><span class="ni ni-plus" style="font-size:22px;font-weight:400"></span>&nbsp;Add Members</a></li>
...
<th class="tb-col"><span class="overline-title">Member Name</span></th>
<th class="tb-col"><span class="overline-title">Designation</span></th>
<th class="tb-col"><span class="overline-title">Sangam </span></th>
...
<?php
$c=1;      
    $sel=mysqli_query($conn,"SELECT * FROM members");
...
<td class="tb-col">
        <div class="media-group">
            <div class="media-text"><?=$fe['mname'];?></div></div></td>

            <td class="tb-col tb-col-md text-danger"><span><b><?=$fe['designation']?></b></span></td>

            <td class="tb-col"><span><?=$fe['sname']?></span></td>


<td class="tb-col"><span><?=$fe['phone']?></span></td>
<td class="tb-col"><div class="media media-md media-middle"><img src=<?=$fe['photo'];?> height="40px" max-width="30px"></div></td>

<td class="tb-col tb-col-end">
            <a href="view-member.php?id=<?=$fe['mid'];?>">
            <em class="icon ni ni-eye"  style="color:black;font-size:23px"></em>


            <a href="edit-member.php?id=<?=$fe['mid'];?>">
